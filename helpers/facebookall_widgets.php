...
class FacebookAllLoginWidget extends WP_Widget {
	...
	function __construct() {
		parent::__construct('facebookalllogin', 'FacebookAll Login', array('description' => __( 'Login or register using Facebook and post on their wall on login.', 'facebookall' ))
			); 
	}  
...
class FacebookAllFanboxWidget extends WP_Widget {
	/** class constructor */ 
	function __construct() {
		parent::__construct('facebookallfanbox', 'FacebookAll Page Plugin', array('description' => __( 'Page Plugin enables Facebook Page owners to attract and gain Likes from their own website.', 'facebookall' ))
			); 
	}  
    function widget( $args, $instance ) { 
		extract( $args ); 
...
class FacebookAllFollowWidget extends WP_Widget {
	/** class constructor */ 
	function __construct() {
		parent::__construct('facebookallfollow', 'FacebookAll Follow Button', array('description' => __( 'The Follow button lets people subscribe to the public updates of others on Facebook.', 'facebookall' )));
	}  
    function widget( $args, $instance ) { 
		extract( $args ); 
...
class FacebookAllSendWidget extends WP_Widget {
	/** class constructor */ 
	function __construct() {
		parent::__construct('facebookallsendbutton', 'FacebookAll Send Button', array('description' => __( 'The Send button lets people privately send content on your site to one or more friends in a Facebook message, to an email address, or share it with a Facebook group.', 'facebookall' ))
			); 
	}  
    function widget( $args, $instance ) { 
		extract( $args ); 
...
class FacebookAllEmbedWidget extends WP_Widget {
	/** class constructor */ 
	function __construct() {
		parent::__construct('facebookallembed', 'FacebookAll Embedded Posts', array('description' => __( 'Embedded Posts are a simple way to put public posts - by a Page or a person on Facebook - into the content of your web site or web page.', 'facebookall' ))
			); 
	}  
    function widget( $args, $instance ) { 
		extract( $args ); 
